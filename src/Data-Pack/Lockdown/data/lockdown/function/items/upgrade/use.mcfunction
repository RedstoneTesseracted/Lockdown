...
execute if items entity @s weapon.mainhand *[minecraft:custom_data~{lockdown_data:{name:"control_tower_upgrade"}}] unless function lockdown:items/upgrade/apply/control_tower run scoreboard players set lockdown.success lockdown.local 1
execute if items entity @s weapon.mainhand *[minecraft:custom_data~{lockdown_data:{name:"durability_upgrade"}}] unless function lockdown:items/upgrade/apply/durability run scoreboard players set lockdown.success lockdown.local 1
