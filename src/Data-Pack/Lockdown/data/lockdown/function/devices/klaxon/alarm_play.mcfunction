...
execute if block ~ ~ ~ minecraft:note_block[note=5] run playsound minecraft:entity.guardian.death block @a[distance=..50] ~ ~ ~ 4.0 1.5
execute if block ~ ~ ~ minecraft:note_block[note=6] run playsound minecraft:block.bell.use block @a[distance=..50] ~ ~ ~ 4.0 1.0
execute if block ~ ~ ~ minecraft:note_block[note=7] run playsound minecraft:block.bell.use block @a[distance=..50] ~ ~ ~ 4.0 0.5
