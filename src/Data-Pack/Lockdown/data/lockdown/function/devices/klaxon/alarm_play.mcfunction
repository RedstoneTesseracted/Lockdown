...
execute if block ~ ~ ~ minecraft:note_block[note=2] run playsound lockdown:alarm.industrial_alarm block @a[distance=..50] ~ ~ ~ 4.0 1.0
execute if block ~ ~ ~ minecraft:note_block[note=3] run playsound lockdown:alarm.spaceship_alarm block @a[distance=..50] ~ ~ ~ 4.0 1.0
execute if block ~ ~ ~ minecraft:note_block[note=4] run playsound minecraft:entity.elder_guardian.curse block @a[distance=..50] ~ ~ ~ 4.0 0.75
execute if block ~ ~ ~ minecraft:note_block[note=5] run playsound minecraft:entity.elder_guardian.curse block @a[distance=..50] ~ ~ ~ 4.0 1.25
