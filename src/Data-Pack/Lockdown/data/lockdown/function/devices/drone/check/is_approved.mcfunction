...
execute if score lockdown.result lockdown.local matches 0 run tellraw @a[gamemode=creative,tag=lockdown.enable_messages] {text: "Function macro lockdown:devices/drone/check/__is_approved did not run", color: "red"}
