...
$execute as @a[distance=..$(range),gamemode=!spectator,gamemode=!creative] unless score @s lockdown.held_channel = lockdown.channel lockdown.local run tag @s add lockdown.drone.candidate
