...
execute store success score lockdown.macro_status lockdown.local align xyz positioned ~-0.5 ~-0.5 ~-0.5 as @e[dx=0,dy=0,dz=0,type=!#lockdown:laser_ignore,tag=!lockdown.projectile] run function lockdown:projectile/damage_macro with storage lockdown:temp args
...
# Destroy entity
function lockdown:projectile/common_destroy
