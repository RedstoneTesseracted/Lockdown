...
execute on vehicle at @s positioned ~-0.5 ~-0.5 ~-0.5 as @e[type=!#lockdown:laser_ignore,dx=0,dy=0,dz=0,tag=!lockdown.laser] run function lockdown:projectile/laser/decide_collision
