...
scoreboard players set lockdown.default_turret_range lockdown.constant 16
scoreboard players set lockdown.default_turret_damage lockdown.constant 8
# Drone
...
scoreboard players set lockdown.default_drone_damage lockdown.constant 5
# Misc
