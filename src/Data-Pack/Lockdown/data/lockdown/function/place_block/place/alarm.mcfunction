...
execute align xyz if entity @e[dx=0.1, dy=0.1, dz=0.1,type=!minecraft:player,tag=!lockdown.placer] run return run function lockdown:place_block/reject/alarm {msg: "lockdown.placer.reject.not_enough_space"}
...
execute unless score lockdown.channel lockdown.local matches 0.. run return run function lockdown:place_block/reject/alarm {msg: "lockdown.placer.reject.no_channel"}
