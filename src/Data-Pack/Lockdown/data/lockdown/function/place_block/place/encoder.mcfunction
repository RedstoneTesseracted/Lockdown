...
execute unless score lockdown.channel lockdown.local matches 0.. run return run function lockdown:place_block/reject/generic {msg: "lockdown.placer.reject.no_channel", loot: "lockdown:item/encoding_station"}
