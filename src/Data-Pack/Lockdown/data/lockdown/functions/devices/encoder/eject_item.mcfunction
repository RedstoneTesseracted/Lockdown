...
execute if score @s ld_result matches 0 run item replace block ~ ~ ~ container.0 with minecraft:rabbit_foot{CustomModelData:10059,display:{Name:'{"text":""}'},LockdownDelete:1b}
...
execute if score @s ld_result matches 0 run item replace block ~ ~ ~ container.1 with minecraft:rabbit_foot{CustomModelData:10061,display:{Name:'{"text":""}'},LockdownDelete:1b}
...
execute if score @s ld_result matches 0 run item replace block ~ ~ ~ container.2 with minecraft:rabbit_foot{CustomModelData:10061,display:{Name:'{"text":""}'},LockdownDelete:1b}
...
execute if score @s ld_result matches 0 run item replace block ~ ~ ~ container.3 with minecraft:rabbit_foot{CustomModelData:10061,display:{Name:'{"text":""}'},LockdownDelete:1b}
...
execute if score @s ld_result matches 0 run item replace block ~ ~ ~ container.5 with minecraft:rabbit_foot{CustomModelData:10060,display:{Name:'{"text":"Write Code","color":"green","italic":"false"}'},LockdownDelete:1b}
