...
item replace block ~ ~ ~ container.16 with birch_button{LockdownItem:1b,LockdownData:{id:6,function_model:10015,block_model:10031,item_model:10031,block_id:1,item_id:1,channel:0},CustomModelData:10031,display:{Name:'{"text":"Big Lime Button","italic":"false","color":"green"}',Lore:['{"text":"No Channel Assigned","color":"red"}']}}
