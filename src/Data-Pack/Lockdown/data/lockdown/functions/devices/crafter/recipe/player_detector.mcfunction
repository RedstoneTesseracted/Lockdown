# Determine how many items (Player Detector) can be crafted
...
item replace block ~ ~ ~ container.16 with gray_glazed_terracotta{LockdownItem:1b,LockdownData:{id:8,function_model:10001,block_model:10000,item_model:10000,block_id:3,item_id:3,channel:-1},CustomModelData:10000,display:{Name:'{"text":"Player Detector","italic":"false"}'}}
