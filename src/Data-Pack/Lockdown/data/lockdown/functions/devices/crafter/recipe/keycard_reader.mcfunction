# Determine how many items (Keycard Reader) can be crafted
...
item replace block ~ ~ ~ container.16 with birch_button{LockdownItem:1b,LockdownData:{id:3,function_model:10033,block_model:10032,item_model:10004,block_id:2,item_id:1,channel:0},CustomModelData:10004,display:{Name:'{"text":"Keycard Reader","italic":"false"}',Lore:['{"text":"No Code/Channel Assigned","color":"red"}']}}
