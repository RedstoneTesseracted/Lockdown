# Determine how many items (Big Purple Button) can be crafted
...
item replace block ~ ~ ~ container.16 with birch_button{LockdownItem:1b,LockdownData:{id:6,function_model:10020,block_model:10036,item_model:10036,block_id:1,item_id:1,channel:0},CustomModelData:10036,display:{Name:'{"text":"Big Purple Button","italic":"false","color":"dark_purple"}',Lore:['{"text":"No Channel Assigned","color":"red"}']}}
