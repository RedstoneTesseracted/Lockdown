# Determine how many items (Gray Alarm) can be crafted
...
item replace block ~ ~ ~ container.16 with birch_button{LockdownItem:1b,LockdownData:{id:5,function_model:10007,block_model:10023,item_model:10049,block_id:2,item_id:1,channel:0},CustomModelData:10049,display:{Name:'{"text":"Gray Alarm","italic":"false","color":"dark_gray"}',Lore:['{"text":"No Channel Assigned","color":"red"}']}}
