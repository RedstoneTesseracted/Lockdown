# Determine how many items (Brown Alarm) can be crafted
...
item replace block ~ ~ ~ container.16 with birch_button{LockdownItem:1b,LockdownData:{id:5,function_model:10012,block_model:10028,item_model:10054,block_id:2,item_id:1,channel:0},CustomModelData:10054,display:{Name:'{"text":"Brown Alarm","italic":"false","color":"gold"}',Lore:['{"text":"No Channel Assigned","color":"red"}']}}
