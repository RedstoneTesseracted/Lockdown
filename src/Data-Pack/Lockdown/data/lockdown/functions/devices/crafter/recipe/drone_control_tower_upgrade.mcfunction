# Determine how many items (Drone Control Tower Upgrade) can be crafted
...
item replace block ~ ~ ~ container.16 with book{LockdownItem:1b,LockdownData:{upgrade:1b,upgrade_id:1},CustomModelData:9999,display:{Name:'{"text":"Drone Control Tower Upgrade","italic":"false"}',Lore:['{"text":"Allows a drone to receive","color":"light_purple","italic":"false"}','{"text":"commands from a control tower","color":"light_purple","italic":"false"}']}}
