# Determine how many items (Green Alarm) can be crafted
...
item replace block ~ ~ ~ container.16 with birch_button{LockdownItem:1b,LockdownData:{id:5,function_model:10013,block_model:10029,item_model:10055,block_id:2,item_id:1,channel:0},CustomModelData:10055,display:{Name:'{"text":"Green Alarm","italic":"false","color":"dark_green"}',Lore:['{"text":"No Channel Assigned","color":"red"}']}}
