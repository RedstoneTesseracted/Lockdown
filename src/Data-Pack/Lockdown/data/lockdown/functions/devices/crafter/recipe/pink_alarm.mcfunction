...
item replace block ~ ~ ~ container.16 with birch_button{LockdownItem:1b,LockdownData:{id:5,function_model:10006,block_model:10022,item_model:10048,block_id:2,item_id:1,channel:0},CustomModelData:10048,display:{Name:'{"text":"Pink Alarm","italic":"false","color":"light_purple"}',Lore:['{"text":"No Channel Assigned","color":"red"}']}}
