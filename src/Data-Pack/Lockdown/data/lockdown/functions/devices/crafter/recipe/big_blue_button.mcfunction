# Determine how many items (Big Blue Button) can be crafted
...
item replace block ~ ~ ~ container.16 with birch_button{LockdownItem:1b,LockdownData:{id:6,function_model:10021,block_model:10037,item_model:10037,block_id:1,item_id:1,channel:0},CustomModelData:10037,display:{Name:'{"text":"Big Blue Button","italic":"false","color":"dark_blue"}',Lore:['{"text":"No Channel Assigned","color":"red"}']}}
