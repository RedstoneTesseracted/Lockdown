...
item replace block ~ ~ ~ container.16 with gray_glazed_terracotta{LockdownItem:1b,LockdownData:{id:12,function_model:10009,block_model:10008,item_model:10008,block_id:3,item_id:3,channel:0},CustomModelData:10008,display:{Name:'{"text":"Redstone Transmitter","italic":"false"}',Lore:['{"text":"No Channel Assigned","color":"red"}']}}
