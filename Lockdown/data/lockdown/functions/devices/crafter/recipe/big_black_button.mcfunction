...
replaceitem block ~ ~ ~ container.16 birch_button{LockdownItem:1b,LockdownData:{id:6,function_model:10025,block_model:10041,item_model:10041,block_id:1,item_id:1,channel:0},CustomModelData:10041,display:{Name:'{"text":"Big Black Button","italic":"false","color":"dark_gray"}',Lore:['{"text":"No Channel Assigned","color":"red"}']}}
