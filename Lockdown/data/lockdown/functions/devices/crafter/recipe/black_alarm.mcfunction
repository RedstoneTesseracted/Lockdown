...
replaceitem block ~ ~ ~ container.16 birch_button{LockdownItem:1b,LockdownData:{id:5,function_model:10015,block_model:10031,item_model:10057,block_id:2,item_id:1,channel:0},CustomModelData:10057,display:{Name:'{"text":"Black Alarm","italic":"false","color":"dark_gray"}',Lore:['{"text":"No Channel Assigned","color":"red"}']}}
