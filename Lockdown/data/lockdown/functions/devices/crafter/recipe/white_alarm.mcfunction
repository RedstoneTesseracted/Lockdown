...
replaceitem block ~ ~ ~ container.16 birch_button{LockdownItem:1b,LockdownData:{id:5,function_model:10000,block_model:10016,item_model:10042,block_id:2,item_id:1,channel:0},CustomModelData:10042,display:{Name:'{"text":"White Alarm","italic":"false","color":"white"}',Lore:['{"text":"No Channel Assigned","color":"red"}']}}
