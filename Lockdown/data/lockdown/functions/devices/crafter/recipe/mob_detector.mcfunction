# Determine how many items (Mob Detector) can be crafted
...
item replace block ~ ~ ~ container.16 with gray_glazed_terracotta{LockdownItem:1b,LockdownData:{id:9,function_model:10003,block_model:10002,item_model:10002,block_id:3,item_id:3,channel:-1},CustomModelData:10002,display:{Name:'{"text":"Mob Detector","italic":"false"}'}}
