...
replaceitem block ~ ~ ~ container.16 birch_button{LockdownItem:1b,LockdownData:{id:6,function_model:10024,block_model:10040,item_model:10040,block_id:1,item_id:1,channel:0},CustomModelData:10040,display:{Name:'{"text":"Big Red Button","italic":"false","color":"red"}',Lore:['{"text":"No Channel Assigned","color":"red"}']}}
