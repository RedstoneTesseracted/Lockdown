# Determine how many items (Defense Drone) can be crafted
...
item replace block ~ ~ ~ container.16 with birch_button{LockdownItem:1b,LockdownData:{id:7,function_model:10007,block_model:10006,item_model:10006,block_id:1,item_id:1,channel:0},CustomModelData:10006,display:{Name:'{"text":"Defense Drone","italic":"false"}',Lore:['{"text":"No Code Assigned","color":"red"}','{"text":"Attacks Hostile Mobs","color":"green"}']}}
