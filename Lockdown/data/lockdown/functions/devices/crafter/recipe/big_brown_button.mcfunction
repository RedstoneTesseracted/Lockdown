...
replaceitem block ~ ~ ~ container.16 birch_button{LockdownItem:1b,LockdownData:{id:6,function_model:10022,block_model:10038,item_model:10038,block_id:1,item_id:1,channel:0},CustomModelData:10038,display:{Name:'{"text":"Big Brown Button","italic":"false","color":"gold"}',Lore:['{"text":"No Channel Assigned","color":"red"}']}}
