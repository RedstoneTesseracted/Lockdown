...
replaceitem block ~ ~ ~ container.16 birch_button{LockdownItem:1b,LockdownData:{id:6,function_model:10014,block_model:10030,item_model:10030,block_id:1,item_id:1,channel:0},CustomModelData:10030,display:{Name:'{"text":"Big Yellow Button","italic":"false","color":"yellow"}',Lore:['{"text":"No Channel Assigned","color":"red"}']}}
