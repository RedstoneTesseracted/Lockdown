# Determine how many items (Big Gray Button) can be crafted
...
item replace block ~ ~ ~ container.16 with birch_button{LockdownItem:1b,LockdownData:{id:6,function_model:10017,block_model:10033,item_model:10033,block_id:1,item_id:1,channel:0},CustomModelData:10033,display:{Name:'{"text":"Big Gray Button","italic":"false","color":"dark_gray"}',Lore:['{"text":"No Channel Assigned","color":"red"}']}}
