# Determine how many items (Cyan Alarm) can be crafted
...
item replace block ~ ~ ~ container.16 with birch_button{LockdownItem:1b,LockdownData:{id:5,function_model:10009,block_model:10025,item_model:10051,block_id:2,item_id:1,channel:0},CustomModelData:10051,display:{Name:'{"text":"Cyan Alarm","italic":"false","color":"dark_aqua"}',Lore:['{"text":"No Channel Assigned","color":"red"}']}}
