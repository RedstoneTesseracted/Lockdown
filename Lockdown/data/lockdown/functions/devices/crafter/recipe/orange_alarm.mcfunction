...
replaceitem block ~ ~ ~ container.16 birch_button{LockdownItem:1b,LockdownData:{id:5,function_model:10001,block_model:10017,item_model:10043,block_id:2,item_id:1,channel:0},CustomModelData:10043,display:{Name:'{"text":"Orange Alarm","italic":"false","color":"gold"}',Lore:['{"text":"No Channel Assigned","color":"red"}']}}
