...
replaceitem block ~ ~ ~ container.16 birch_button{LockdownItem:1b,LockdownData:{id:6,function_model:10013,block_model:10029,item_model:10029,block_id:1,item_id:1,channel:0},CustomModelData:10029,display:{Name:'{"text":"Big Light Blue Button","italic":"false","color":"blue"}',Lore:['{"text":"No Channel Assigned","color":"red"}']}}
