# Determine how many items (Purple Alarm) can be crafted
...
item replace block ~ ~ ~ container.16 with birch_button{LockdownItem:1b,LockdownData:{id:5,function_model:10010,block_model:10026,item_model:10052,block_id:2,item_id:1,channel:0},CustomModelData:10052,display:{Name:'{"text":"Purple Alarm","italic":"false","color":"dark_purple"}',Lore:['{"text":"No Channel Assigned","color":"red"}']}}
