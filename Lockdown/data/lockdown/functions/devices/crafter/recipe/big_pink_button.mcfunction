# Determine how many items (Big Pink Button) can be crafted
...
item replace block ~ ~ ~ container.16 with birch_button{LockdownItem:1b,LockdownData:{id:6,function_model:10016,block_model:10032,item_model:10032,block_id:1,item_id:1,channel:0},CustomModelData:10032,display:{Name:'{"text":"Big Pink Button","italic":"false","color":"light_purple"}',Lore:['{"text":"No Channel Assigned","color":"red"}']}}
