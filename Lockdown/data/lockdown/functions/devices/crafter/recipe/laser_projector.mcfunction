...
replaceitem block ~ ~ ~ container.16 gray_glazed_terracotta{LockdownItem:1b,LockdownData:{id:11,function_model:10007,block_model:10006,item_model:10006,block_id:3,item_id:3,channel:-1},CustomModelData:10006,display:{Name:'{"text":"Laser Projector","italic":"false"}'}}
