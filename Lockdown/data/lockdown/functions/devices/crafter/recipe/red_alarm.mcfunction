...
replaceitem block ~ ~ ~ container.16 birch_button{LockdownItem:1b,LockdownData:{id:5,function_model:10014,block_model:10030,item_model:10056,block_id:2,item_id:1,channel:0},CustomModelData:10056,display:{Name:'{"text":"Red Alarm","italic":"false","color":"red"}',Lore:['{"text":"No Channel Assigned","color":"red"}']}}
