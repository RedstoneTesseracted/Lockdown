...
item replace block ~ ~ ~ container.16 with birch_button{LockdownItem:1b,LockdownData:{id:6,function_model:10012,block_model:10028,item_model:10028,block_id:1,item_id:1,channel:0},CustomModelData:10028,display:{Name:'{"text":"Big Magenta Button","italic":"false","color":"light_purple"}',Lore:['{"text":"No Channel Assigned","color":"red"}']}}
