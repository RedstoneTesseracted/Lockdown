...
replaceitem block ~ ~ ~ container.16 birch_button{LockdownItem:1b,LockdownData:{id:6,function_model:10019,block_model:10035,item_model:10035,block_id:1,item_id:1,channel:0},CustomModelData:10035,display:{Name:'{"text":"Big Cyan Button","italic":"false","color":"dark_aqua"}',Lore:['{"text":"No Channel Assigned","color":"red"}']}}
