# Determine how many items (Big White Button) can be crafted
...
item replace block ~ ~ ~ container.16 with birch_button{LockdownItem:1b,LockdownData:{id:6,function_model:10010,block_model:10026,item_model:10026,block_id:1,item_id:1,channel:0},CustomModelData:10026,display:{Name:'{"text":"Big White Button","italic":"false","color":"white"}',Lore:['{"text":"No Channel Assigned","color":"red"}']}}
