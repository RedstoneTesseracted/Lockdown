...
replaceitem block ~ ~ ~ container.16 birch_button{LockdownItem:1b,LockdownData:{id:5,function_model:10011,block_model:10027,item_model:10053,block_id:2,item_id:1,channel:0},CustomModelData:10053,display:{Name:'{"text":"Blue Alarm","italic":"false","color":"dark_blue"}',Lore:['{"text":"No Channel Assigned","color":"red"}']}}
