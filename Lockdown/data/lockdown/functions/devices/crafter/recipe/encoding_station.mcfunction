...
replaceitem block ~ ~ ~ container.16 gray_glazed_terracotta{LockdownItem:1b,LockdownData:{id:16,function_model:10014,block_model:10014,item_model:10014,block_id:3,item_id:3,channel:-1},CustomModelData:10014,display:{Name:'{"text":"Encoding Station","italic":"false"}'}}
