...
replaceitem block ~ ~ ~ container.16 birch_button{LockdownItem:1b,LockdownData:{id:6,function_model:10011,block_model:10027,item_model:10027,block_id:1,item_id:1,channel:0},CustomModelData:10027,display:{Name:'{"text":"Big Orange Button","italic":"false","color":"gold"}',Lore:['{"text":"No Channel Assigned","color":"red"}']}}
