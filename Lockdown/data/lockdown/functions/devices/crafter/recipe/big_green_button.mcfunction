...
item replace block ~ ~ ~ container.16 with birch_button{LockdownItem:1b,LockdownData:{id:6,function_model:10023,block_model:10039,item_model:10039,block_id:1,item_id:1,channel:0},CustomModelData:10039,display:{Name:'{"text":"Big Green Button","italic":"false","color":"dark_green"}',Lore:['{"text":"No Channel Assigned","color":"red"}']}}
