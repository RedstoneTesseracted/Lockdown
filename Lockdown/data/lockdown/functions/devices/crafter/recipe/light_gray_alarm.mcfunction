...
replaceitem block ~ ~ ~ container.16 birch_button{LockdownItem:1b,LockdownData:{id:5,function_model:10008,block_model:10024,item_model:10050,block_id:2,item_id:1,channel:0},CustomModelData:10050,display:{Name:'{"text":"Light Gray Alarm","italic":"false","color":"gray"}',Lore:['{"text":"No Channel Assigned","color":"red"}']}}
