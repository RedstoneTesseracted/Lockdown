...
replaceitem block ~ ~ ~ container.16 gray_glazed_terracotta{LockdownItem:1b,LockdownData:{id:13,function_model:10011,block_model:10010,item_model:10010,block_id:3,item_id:3,channel:0},CustomModelData:10010,display:{Name:'{"text":"Redstone Receiver","italic":"false"}',Lore:['{"text":"No Channel Assigned","color":"red"}']}}
