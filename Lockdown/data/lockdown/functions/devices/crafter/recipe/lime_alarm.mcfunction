...
replaceitem block ~ ~ ~ container.16 birch_button{LockdownItem:1b,LockdownData:{id:5,function_model:10005,block_model:10021,item_model:10047,block_id:2,item_id:1,channel:0},CustomModelData:10047,display:{Name:'{"text":"Lime Alarm","italic":"false","color":"green"}',Lore:['{"text":"No Channel Assigned","color":"red"}']}}
