...
replaceitem block ~ ~ ~ container.16 birch_button{LockdownItem:1b,LockdownData:{id:6,function_model:10018,block_model:10034,item_model:10034,block_id:1,item_id:1,channel:0},CustomModelData:10034,display:{Name:'{"text":"Big Light Gray Button","italic":"false","color":"gray"}',Lore:['{"text":"No Channel Assigned","color":"red"}']}}
