# Determine how many items (Yellow Alarm) can be crafted
...
item replace block ~ ~ ~ container.16 with birch_button{LockdownItem:1b,LockdownData:{id:5,function_model:10004,block_model:10020,item_model:10046,block_id:2,item_id:1,channel:0},CustomModelData:10046,display:{Name:'{"text":"Yellow Alarm","italic":"false","color":"yellow"}',Lore:['{"text":"No Channel Assigned","color":"red"}']}}
