...
replaceitem block ~ ~ ~ container.16 birch_button{LockdownItem:1b,LockdownData:{id:5,function_model:10003,block_model:10019,item_model:10045,block_id:2,item_id:1,channel:0},CustomModelData:10045,display:{Name:'{"text":"Light Blue Alarm","italic":"false","color":"blue"}',Lore:['{"text":"No Channel Assigned","color":"red"}']}}
